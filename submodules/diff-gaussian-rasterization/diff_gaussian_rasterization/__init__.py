...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, contrib_id, contrib_w = _C.rasterize_gaussians(*args)
        ...
        return color, radii, accumulation, contrib_id, contrib_w

    @staticmethod
    def backward(ctx, grad_out_color, _1, _2, _3, _4):
