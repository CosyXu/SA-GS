...
class Config:
    ...
    appearance_model_sh: bool = True  # False
    appearance_sh_degree: int = 3
    ...
    uncertainty_backbone: str = "dinov2_vits14_reg"   #"dinov2_base_sat"   # dinov2_vits14_reg
    ...
    season_nums: int = 5 # 3
    season_embedding_dim: int = 32
    season_embedding_lr: float = 0.001
    season_embedding_regularization: float = 0.0

    lpips_loss: bool = True
    lambda_lpips: float = 0.005

    # WARPING
    use_warping: bool = True  # True
    num_virtuals: int = 200
    pick_virtual_interval: int = 2
    lambda_virtual: float = 1.0
    virtual_stages: int = 1

    opacity_decay: bool = True
    opacity_decay_factor: float = 0.999 # 0.999